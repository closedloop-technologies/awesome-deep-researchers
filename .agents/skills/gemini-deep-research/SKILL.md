...
description: Call or prepare Google Gemini Deep Research Agent tasks with search grounding and bounded scope.
---
...
```bash
op run --env-file .env.adr -- python .agents/skills/gemini-deep-research/scripts/gemini_research.py \
