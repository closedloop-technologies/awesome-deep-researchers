---
name: custom-data-deep-research
description: Plan and run deep research over custom data sources such as Google Docs, YouTube, local files, S3 buckets, arXiv papers, databases, Slack, email, and tickets.
---
